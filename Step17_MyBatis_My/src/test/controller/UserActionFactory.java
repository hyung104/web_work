...
import test.cafe.action.CafeCheckRecommendAction;
...
import test.cafe.action.CafeRecommendAction;
...
import test.file.action.FileUpload_formAction;
...
import test.gallery.action.GalleryViewImageAction;
...
public class UserActionFactory {
	...
	public Action action(String command){
		...
		if(command.equals("/home")) {
			...
			action=new FileUpload_formAction();
		...
		}else if(command.equals("/cafe/isValidRecommend")) {			
			action=new CafeCheckRecommendAction();
		}else if(command.equals("/cafe/recommend")) {			
			action=new CafeRecommendAction();
		}else if(command.equals("/cafe/private/commentDelete")){
		...
		}else if (command.equals("/gallery/viewImage")) {
			action=new GalleryViewImageAction();
